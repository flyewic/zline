...
/// Zero is special-cased to return 1 since log10_int(0) panics.
...
/// Sorts the language totals and dispatches to the chosen output format
/// (table, json, or csv). Handles empty totals by returning early.
