class Zline < Formula
  ...
  url "https://github.com/flyewic/zline/releases/download/v0.3.3/zline-x86_64-linux"
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/flyewic/zline/releases/download/v0.3.3/zline-aarch64-macos"
      sha256 "PASTE_SHA256_FOR_zline-aarch64-macos_HERE"
    else
      url "https://github.com/flyewic/zline/releases/download/v0.3.3/zline-x86_64-macos"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/flyewic/zline/releases/download/v0.3.3/zline-aarch64-linux"
